...
// Install with `sudo make lily58:default:dfu`
...
[_LOWER] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_EQL,  \
